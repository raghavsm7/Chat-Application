...
function Signup() {
  ...
  const onSubmit = async (data) => {
    ...
    // }
    const userInfo = new FormData(); // Use FormData to handle file upload
    userInfo.append("fullname", data.fullname);
    userInfo.append("email", data.email);
    userInfo.append("password", data.password);
    userInfo.append("confirmPassword", data.password);

    // Append profile photo if selected
    if (profilePhoto) {
      userInfo.append("profilePhoto", profilePhoto);
    }
    ...
    <>
      <div className="flex items-center justify-center h-screen ">
        ...
        >
          ...
          <h2 className="text-xl text-black font-bold">Sign Up</h2>
          <br />
          {/* fullname */}
          ...
          <div className="flex justify-between">
            ...
            <input
              type="submit"
              value="Signup"
              className="text-black bg-green-500 px-2 py-1 rounded-lg cursor-pointer"
            />
          </div>
        </form>
      </div>
